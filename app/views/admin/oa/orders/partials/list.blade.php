...
<h1 class='bs-callout-header bs-callout-{{$calloutType}}'>{{$pageTitle}} Orders for {{$date}} ({{$orderQty}} orders)</h1>
                    ...
                    <td colspan='7'>
                        ...
                        <table class="table table-condensed">
                            <tbody>
                                ...
                                $totalBentos += $boxCount;
                                $totalCouponAmt += $row->coupon_discount;
                                ?>
...
<hr>
Total Orders: {{$orderQty}}<br>
Total Bentos: {{$totalBentos}}<br>
Total Revenue: ${{$totalRevenue}}<br>
Total Coupon Usage: ${{$totalCouponAmt}}<br>
<hr>
<br>
